...
public class MissileCooldownBar : ProgressBar
{
    ...
    public override void _Process(float delta)
    {
        ...
        {
            Timer t = (currentPlayer.GetNode("MissileTimer") as Timer);


            Value = 100 * (1f-(t.TimeLeft / EquipmentHandler.Instance.equippedWeapon.CooldownSeconds));
